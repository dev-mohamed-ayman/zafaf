...
@section('content')
    <div class="row">
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
                <div class="inner">
                    <h3>{{ App\Models\Hall::where('user_id', auth()->user()->id)->count() }}</h3>
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{ App\Models\Hall::where('user_id', auth()->user()->id)->sum('visits') }}</h3>
    ...
    <div class="card mt-4">
        <div class="card-header">
            ...
            <form action="{{ route('company.top.ten') }}" method="get">
                        ...
                        <table class="table table-striped table-hover table-bordered text-center">
                            ...
                            <tbody>
                                @forelse($items as $item)
                                    <tr>
                                        <th>{{ $loop->index + 1 }}</th>
                                        <td><a href="{{ route('hall.details', $item->id) }}">{{ $item->name }}</a></td>
