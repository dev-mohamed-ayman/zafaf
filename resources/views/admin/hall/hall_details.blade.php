<div class="form-group col-md-6">
    ...
    <input type="text" name="hall[women_size]" value="{{old('hall[men_size]')}}" class="form-control"
           placeholder="سعة قسم النساء">
</div>
<div class="form-group col-md-6">
    <label class="form-label">سعة قسم الرجال</label>
    <input type="text" name="hall[men_size]" value="{{old('hall[women_size]')}}" class="form-control"
           placeholder="سعة قسم الرجال">
</div>
<div class="form-group col-md-6">
    <label class="form-label">سعة صالة الطعام</label>
    <input type="text" name="hall[dining_room_size]" value="{{old('hall[dining_room_size]')}}"
           class="form-control" placeholder="سعة صالة الطعام">
</div>
<div class="form-group col-md-6">
    <label class="form-label">عدد القاعات في الصالة </label>
    <input type="text" name="hall[hall_count]" value="{{old('hall[hall_count]')}}" class="form-control"
...
<div class="form-group col-md-6">
    ...
    <select name="hall[separating_halls]" class="form-control">
        ...
        <option value="0" {{ old('hall[separating_halls]') == '0' ? 'selected' : '' }}>يمكن</option>
        <option value="1" {{ old('hall[separating_halls]') == '1' ? 'selected' : '' }}>لايمكن</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[separate_dining_hall]" class="form-control">
        ...
        <option value="0" {{ old('hall[separate_dining_hall]') == '0' ? 'selected' : '' }}>يمكن
        </option>
        <option value="1" {{ old('hall[separate_dining_hall]') == '1' ? 'selected' : '' }}>لايمكن
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[men_council]" class="form-control">
        ...
        <option value="0" {{ old('hall[men_council]') == '0' ? 'selected' : '' }}>يمكن</option>
        <option value="1" {{ old('hall[men_council]') == '1' ? 'selected' : '' }}>لايمكن</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[free_suite]" class="form-control">
        ...
        <option value="0" {{ old('hall[free_suite]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[free_suite]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[sacrifices]" class="form-control">
        ...
        <option value="0" {{ old('hall[sacrifices]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[sacrifices]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[hot_cold_drinks]" class="form-control">
        ...
        <option value="0" {{ old('hall[hot_cold_drinks]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[hot_cold_drinks]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[lights]" class="form-control">
        ...
        <option value="0" {{ old('hall[lights]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[lights]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[photography_and_video]" class="form-control">
        ...
        <option value="0" {{ old('hall[photography_and_video]') == '0' ? 'selected' : '' }}>يوجد
        </option>
        <option value="1" {{ old('hall[photography_and_video]') == '1' ? 'selected' : '' }}>لايوجد
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[separate_entrance]" class="form-control">
        ...
        <option value="0" {{ old('hall[separate_entrance]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[separate_entrance]') == '1' ? 'selected' : '' }}>لايوجد
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[staircase_wedding]" class="form-control">
        ...
        <option value="0" {{ old('hall[staircase_wedding]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[staircase_wedding]') == '1' ? 'selected' : '' }}>لايوجد
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[phone_inspector]" class="form-control">
        ...
        <option value="0" {{ old('hall[phone_inspector]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[phone_inspector]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[abayas_official]" class="form-control">
        ...
        <option value="0" {{ old('hall[abayas_official]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[abayas_official]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[hall_supervisor]" class="form-control">
        ...
        <option value="0" {{ old('hall[hall_supervisor]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[hall_supervisor]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[click]" class="form-control">
        ...
        <option value="0" {{ old('hall[click]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[click]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[wedding_cake]" class="form-control">
        ...
        <option value="0" {{ old('hall[wedding_cake]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[wedding_cake]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[female_workers]" class="form-control">
        ...
        <option value="0" {{ old('hall[female_workers]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[female_workers]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[subs_directs]" class="form-control">
        ...
        <option value="0" {{ old('hall[subs_directs]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[subs_directs]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[coffee_men]" class="form-control">
        ...
        <option value="0" {{ old('hall[coffee_men]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[coffee_men]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[security_guard]" class="form-control">
        ...
        <option value="0" {{ old('hall[security_guard]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[security_guard]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[buffet_company]" class="form-control">
        ...
        <option value="0" {{ old('hall[buffet_company]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[buffet_company]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[holding_several_parties_at_the_same_time]" class="form-control">
        ...
        <option value="0" {{ old('hall[holding_several_parties_at_the_same_time]') == '0' ? 'selected' : '' }}>
            يوجد
        </option>
        <option value="1" {{ old('hall[holding_several_parties_at_the_same_time]') == '1' ? 'selected' : '' }}>
            لايوجد
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[car_parking]" class="form-control">
        ...
        <option value="0" {{ old('hall[car_parking]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[car_parking]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[entry_children]" class="form-control">
        ...
        <option value="0" {{ old('hall[entry_children]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[entry_children]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[kosha_and_hall_coordination]" class="form-control">
        ...
        <option value="0" {{ old('hall[kosha_and_hall_coordination]') == '0' ? 'selected' : '' }}>
            يوجد
        </option>
        <option value="1" {{ old('hall[kosha_and_hall_coordination]') == '1' ? 'selected' : '' }}>
            لايوجد
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[dj]" class="form-control">
        ...
        <option value="0" {{ old('hall[dj]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[dj]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[bride_room]" class="form-control">
        ...
        <option value="0" {{ old('hall[bride_room]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[bride_room]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[vip_room]" class="form-control">
        ...
        <option value="0" {{ old('hall[vip_room]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[vip_room]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[food_buffet]" class="form-control">
        ...
        <option value="0" {{ old('hall[food_buffet]') == '0' ? 'selected' : '' }}>يوجد</option>
        <option value="1" {{ old('hall[food_buffet]') == '1' ? 'selected' : '' }}>لايوجد</option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[the_price_is_lower_when_booking_the_women_hall_only]" class="form-control">
        ...
        <option
            value="0" {{ old('hall[the_price_is_lower_when_booking_the_women_hall_only]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option
            value="1" {{ old('hall[the_price_is_lower_when_booking_the_women_hall_only]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[the_price_includes_dinner]" class="form-control">
        ...
        <option value="0" {{ old('hall[the_price_includes_dinner]') == '0' ? 'selected' : '' }}>نعم
        </option>
        <option value="1" {{ old('hall[the_price_includes_dinner]') == '1' ? 'selected' : '' }}>لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[does_the_price_differ_when_booking_on_holidays_and_weekend]"
        ...
        <option
            value="0" {{ old('hall[does_the_price_differ_when_booking_on_holidays_and_weekend]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option
            value="1" {{ old('hall[does_the_price_differ_when_booking_on_holidays_and_weekend]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[reservations_are_not_made_without_dinner]" class="form-control">
        ...
        <option value="0" {{ old('hall[reservations_are_not_made_without_dinner]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option value="1" {{ old('hall[reservations_are_not_made_without_dinner]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <input type="text" name="hall[what_is_the_minimum_number_to_reserve_the_hall]"
           value="{{old('hall[what_is_the_minimum_number_to_reserve_the_hall]')}}"
           class="form-control"
...
<div class="form-group col-md-6">
    ...
    <input type="text" name="hall[what_time_does_the_hall_close]"
           value="{{old('hall[what_time_does_the_hall_close]')}}" class="form-control"
...
<div class="form-group col-md-6">
    ...
    <select name="hall[observe_social_distancing_measures]" class="form-control">
        ...
        <option value="0" {{ old('hall[observe_social_distancing_measures]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option value="1" {{ old('hall[observe_social_distancing_measures]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[wide_space_between_tables]" class="form-control">
        ...
        <option value="0" {{ old('hall[wide_space_between_tables]') == '0' ? 'selected' : '' }}>نعم
        </option>
        <option value="1" {{ old('hall[wide_space_between_tables]') == '1' ? 'selected' : '' }}>لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[complete_cleanse_before_every_event]" class="form-control">
        ...
        <option value="0" {{ old('hall[complete_cleanse_before_every_event]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option value="1" {{ old('hall[complete_cleanse_before_every_event]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[hand_sanitizer_in_specific_places]" class="form-control">
        ...
        <option value="0" {{ old('hall[hand_sanitizer_in_specific_places]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option value="1" {{ old('hall[hand_sanitizer_in_specific_places]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[sterile_wipes_for_each_table]" class="form-control">
        ...
        <option value="0" {{ old('hall[sterile_wipes_for_each_table]') == '0' ? 'selected' : '' }}>نعم
        </option>
        <option value="1" {{ old('hall[sterile_wipes_for_each_table]') == '1' ? 'selected' : '' }}>لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[regular_ventilation_of_the_hall]" class="form-control">
        ...
        <option value="0" {{ old('hall[regular_ventilation_of_the_hall]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option value="1" {{ old('hall[regular_ventilation_of_the_hall]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[hospitality_in_special_and_closed_boxes]" class="form-control">
        ...
        <option value="0" {{ old('hall[hospitality_in_special_and_closed_boxes]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option value="1" {{ old('hall[hospitality_in_special_and_closed_boxes]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[disposable_eating_utensils]" class="form-control">
        ...
        <option value="0" {{ old('hall[disposable_eating_utensils]') == '0' ? 'selected' : '' }}>نعم
        </option>
        <option value="1" {{ old('hall[disposable_eating_utensils]') == '1' ? 'selected' : '' }}>لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[providing_the_service_staff_with_gloves_and_masks]" class="form-control">
        ...
        <option value="0" {{ old('hall[providing_the_service_staff_with_gloves_and_masks]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option value="1" {{ old('hall[providing_the_service_staff_with_gloves_and_masks]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[temperature_measuring_devices_at_the_entrance]" class="form-control">
        ...
        <option value="0" {{ old('hall[temperature_measuring_devices_at_the_entrance]') == '0' ? 'selected' : '' }}>
            نعم
        </option>
        <option value="1" {{ old('hall[temperature_measuring_devices_at_the_entrance]') == '1' ? 'selected' : '' }}>
            لا
        </option>
    </select>
</div>
<div class="form-group col-md-6">
    ...
    <select name="hall[sensor_operated_faucets]" class="form-control">
        ...
        <option value="0" {{ old('hall[sensor_operated_faucets]') == '0' ? 'selected' : '' }}>نعم
        </option>
        <option value="1" {{ old('hall[sensor_operated_faucets]') == '1' ? 'selected' : '' }}>لا
        </option>
    </select>
</div>
