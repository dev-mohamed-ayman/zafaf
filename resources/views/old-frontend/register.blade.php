...
<div class="auth py-5">
    <div class="py-5">
        ...
        <form action="{{route('register.post')}}" method="post">
            ...
            <input type="password" name="password_confirmation" class="py-3 px-4 mt-4 fw-bold" placeholder="@lang('confirm password')">
            <button type="submit" class="px-5 py-3 border-0 bg-red-color text-light d-block mx-auto fw-bold rounded-pill mt-4">@lang('Signup')</button>
        </form>
            <a href="{{route('login')}}" class="text-center mt-2 d-block text-main-color-2 text-decoration-none fw-bold">@lang('Have an account Register')</a>
    </div>
</div>
